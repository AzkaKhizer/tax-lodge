        ...
        >
          ...
          <div>
            ...
            <ul className="text-sm md:text-sm space-y-1">
              {["About Us", "Our Services", "Pricing Plan", "Blog", "Business Tax", "Online Tax Return", "Pay Calculator", "Terms & Conditions", "Privacy Policy", "Refund Policy", "Contact Us"].map((link, index) => (
                <li key={index}>
                  <a href={`/${link.replace(/\s+/g, '').toLowerCase()}`} className="hover:text-[#FE5722] hover:underline transition-colors duration-300">
                    {link}
                  </a>
                </li>
              ))}
      ...
      <div className="block md:hidden">
        <div className="flex flex-col items-center justify-center bg-gray-100">
          ...
          <ul className="space-y-2 text-center">
            {["About Us", "Our Services", "Pricing Plan", "Blog", "Contact Us", "Terms & Conditions", "Privacy Policy", "Refund Policy"].map((item, index) => (
