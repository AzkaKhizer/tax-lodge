        ...
        <RelatedBlog1/>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Image src="/author2.png" alt="Author 1" width={20} height={20} className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover transition-transform transform hover:scale-105 hover:shadow-lg" />
                    <Image src="/author1.png" alt="Author 2" width={20} height={20} className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover transition-transform transform hover:scale-105 hover:shadow-lg" />
                  </div>
                </motion.div>
